...
type Props = {
 ...
 export const TextSection = ({title,desc}: Props) => {
  ...
  return (
    ...
    >
        <h2 className='font-bold lg:text-8xl text-5xl sm:text-6xl text-center'>{title}</h2>
        <p className='lg:text-2xl text-base mt-8 sm:mt-4 sm:text-lg md:text-xl text-muted-foreground'>{desc}</p>
        <div
        aria-hidden="true"
